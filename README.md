...
* 0_olist_csv_dataset - all OLIST public dataset files in csv format, togheter with a script python that shows statistics about those csv files thanks to pandas libraries. A requirements.txt file is available to install all needed python requirements via pip.  
